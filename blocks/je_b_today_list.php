...
//區塊主函式 (je_b_today_list)
function je_b_today_list($options){
...
//區塊編輯函式 (je_b_today_list_edit)
function je_b_today_list_edit($options){
    ...
    <ol class='my-form'>
        ...
        <!--伸縮頁籤-->
        <li class='my-row'>
            <lable class='my-label'>"._MB_JE_B_TODAY_LIST_OPT0."</lable>
